...
namespace ImGui
{
    ...
    IMGUI_API void          ImRotateStart();
    IMGUI_API ImVec2        ImRotationCenter();
    IMGUI_API void          ImRotateEnd(float rad, ImVec2 center = ImRotationCenter());
